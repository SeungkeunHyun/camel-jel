define(["jquery", "underscore", "backbone", "ractive", "xsdAttr", "jel", "text!templates/properties.html", "text!templates/propertyHeader.html", "text!templates/propertiesSelect.html"],
    function ($, _, Backbone, Ractive, xsdAttr, Jel, template, header, propertiesSelect ) {
            ...
            for(var propName in this.model.props){
                if(this.model.props.hasOwnProperty(propName)){
                    ...
                    if(this.model.props[propName] instanceof Array){
                        ...
                        curr_select = { "select" : this.model.props[propName]};
                        this.template = new Ractive({el : $(this.el), template: propertiesSelect, data: curr_select, append:true});
